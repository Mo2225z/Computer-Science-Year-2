public class Player extends Person {
    ...
    public Player(String position, double fitness, double passingAccuracy, double shotAccuracy, double shotFrequency, double defensiveness, double aggression, double positioning, double dribbling, double chanceCreation, double offsideAdherence , String name, String surname, String team) {
    ...
    public double getPlayerAverage() {
        double playerAverage = (fitness + passingAccuracy + shotAccuracy + shotFrequency + defensiveness + aggression
                + positioning + dribbling + chanceCreation + offsideAdherence) / 10.0;

        return  ((int) (10000.0 * playerAverage)) / 100.0;
    }
}
